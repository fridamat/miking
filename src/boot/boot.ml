...
let init_seqmethod_assoc_list =
  ...
  let fun_names = ["length";"append";"push"] in
...
let eval_test typecheck env t =
  ...
  if typecheck then
    ...
    (*let selected_data_structures = Dssa.main mf_matrix2 in*) (*TODO: This step gets nth error*)
    let selected_data_structures = [[0];[0]] in
