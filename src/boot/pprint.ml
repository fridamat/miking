...
and pprint basic t =
  ...
  | TmSeq(fi,ty_ident,clist,tmseq,ds_choice) -> us"TmSeq(" ^. (pprint_tm_list clist) ^. us")" ^. us"(" ^. (pprint_sequence tmseq) ^. us"){" ^. us(string_of_int ds_choice) ^. us"}"
...
and pprint_seqfuntype seq_fun =
  match seq_fun with
  | SeqListFun1 _ -> "SeqListFun 1"
  | SeqListFun2 _ -> "SeqListFun 2"
  | SeqListFun3 _ -> "SeqListFun 3"
  | SeqListFun4 _ -> "SeqListFun 4"
  | SeqListFun5 _ -> "SeqListFun 5"
  | SeqListFun6 _ -> "SeqListFun 6"
  | SeqListFun7 _ -> "SeqListFun 7"
  | SeqListFun8 _ -> "SeqListFun 8"
  | SeqListFun9 _ -> "SeqListFun 9"
  | SeqListFun10 _ -> "SeqListFun 10"
  | SeqListFun11 _ -> "SeqListFun 11"
  | SeqListFun12 _ -> "SeqListFun 12"
  | SeqListFun13 _ -> "SeqListFun 13"
  | SeqQueueFun1 _ -> "SeqQueueFun 1"
  | SeqQueueFun2 _ -> "SeqQueueFun 2"
  | SeqQueueFun3 _ -> "SeqQueueFun 3"
  | SeqQueueFun4 _ -> "SeqQueueFun 4"
  | SeqQueueFun5 _ -> "SeqQueueFun 5"
  | SeqQueueFun6 _ -> "SeqQueueFun 6"
  | SeqQueueFun7 _ -> "SeqQueueFun 7"
  | SeqQueueFun8 _ -> "SeqQueueFun 8"
  | SeqQueueFun9 _ -> "SeqQueueFun 9"
  | SeqQueueFun10 _ -> "SeqQueueFun 10"
  | SeqQueueFun11 _ -> "SeqQueueFun 11"
  | SeqQueueFun12 _ -> "SeqQueueFun 12"
  | SeqQueueFun13 _ -> "SeqQueueFun 13"
  | SeqOArrayFun1 _ -> "SeqOArrayFun 1"
  | SeqOArrayFun2 _ -> "SeqOArrayFun 2"
  | SeqOArrayFun3 _ -> "SeqOArrayFun 3"
  | SeqOArrayFun4 _ -> "SeqOArrayFun 4"
  | SeqOArrayFun5 _ -> "SeqOArrayFun 5"
  | SeqOArrayFun6 _ -> "SeqOArrayFun 6"
  | SeqOArrayFun7 _ -> "SeqOArrayFun 7"
  | SeqOArrayFun8 _ -> "SeqOArrayFun 8"
  | SeqOArrayFun9 _ -> "SeqOArrayFun 9"
  | SeqOArrayFun10 _ -> "SeqOArrayFun 10"
  | SeqOArrayFun11 _ -> "SeqOArrayFun 11"
  | SeqOArrayFun12 _ -> "SeqOArrayFun 12"
  | SeqOArrayFun13 _ -> "SeqOArrayFun 13"
  | SeqOQueueFun1 _ -> "SeqOQueueFun 1"
  | SeqOQueueFun2 _ -> "SeqOQueueFun 2"
  | SeqOQueueFun3 _ -> "SeqOQueueFun 3"
  | SeqOQueueFun4 _ -> "SeqOQueueFun 4"
  | SeqOQueueFun5 _ -> "SeqOQueueFun 5"
  | SeqOQueueFun6 _ -> "SeqOQueueFun 6"
  | SeqOQueueFun7 _ -> "SeqOQueueFun 7"
  | SeqOQueueFun8 _ -> "SeqOQueueFun 8"
  | SeqOQueueFun9 _ -> "SeqOQueueFun 9"
  | SeqOQueueFun10 _ -> "SeqOQueueFun 10"
  | SeqOQueueFun11 _ -> "SeqOQueueFun 11"
  | SeqOQueueFun12 _ -> "SeqOQueueFun 12"
  | SeqOQueueFun13 _ -> "SeqOQueueFun 13"
  | SeqOStackFun1 _ -> "SeqOStackFun 1"
  | SeqOStackFun2 _ -> "SeqOStackFun 2"
  | SeqOStackFun3 _ -> "SeqOStackFun 3"
  | SeqOStackFun4 _ -> "SeqOStackFun 4"
  | SeqOStackFun5 _ -> "SeqOStackFun 5"
  | SeqOStackFun6 _ -> "SeqOStackFun 6"
  | SeqOStackFun7 _ -> "SeqOStackFun 7"
  | SeqOStackFun8 _ -> "SeqOStackFun 8"
  | SeqOStackFun9 _ -> "SeqOStackFun 9"
  | SeqOStackFun10 _ -> "SeqOStackFun 10"
  | SeqOStackFun11 _ -> "SeqOStackFun 11"
  | SeqOStackFun12 _ -> "SeqOStackFun 12"
  | SeqOStackFun13 _ -> "SeqOStackFun 13"
  | SeqFunNone -> "NO Fun"
