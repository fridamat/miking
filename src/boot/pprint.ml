...
and pprint_seqfuntype seq_fun =
  ...
  | SeqRTQueueFun1 _ -> "SeqRTQueueFun 1"
  | SeqRTQueueFun2 _ -> "SeqRTQueueFun 2"
  | SeqRTQueueFun3 _ -> "SeqRTQueueFun 3"
  | SeqRTQueueFun4 _ -> "SeqRTQueueFun 4"
  | SeqRTQueueFun5 _ -> "SeqRTQueueFun 5"
  | SeqRTQueueFun6 _ -> "SeqRTQueueFun 6"
  | SeqRTQueueFun7 _ -> "SeqRTQueueFun 7"
  | SeqRTQueueFun8 _ -> "SeqRTQueueFun 8"
  | SeqRTQueueFun9 _ -> "SeqRTQueueFun 9"
  | SeqRTQueueFun10 _ -> "SeqRTQueueFun 10"
  | SeqRTQueueFun11 _ -> "SeqRTQueueFun 11"
  | SeqRTQueueFun12 _ -> "SeqRTQueueFun 12"
  | SeqRTQueueFun13 _ -> "SeqRTQueueFun 13"
  | SeqFunNone -> "NO Fun"
